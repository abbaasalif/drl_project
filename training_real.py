...
env = real_env.Environment(optimal_temperature = (18.0, 24.0), initial_month = 0)

# BUILDING THE BRAIN BY SIMPLY CREATING AN OBJECT OF THE BRAIN CLASS
brain = brain.Brain(learning_rate = 0.0711279701466562, weight_decay=0.05113039126717029, layers=[64,32],dropout =0.2560726974925277,activation = 'tanh', optimizer='adam',num_actions = number_actions)
