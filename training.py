...
brain = brain.Brain(learning_rate = 0.00021183469137279494, weight_decay=0.0021280082545197657, layers=[64,32],dropout = 0.12481124588671155,activation = 'relu', optimizer='rmsprop',num_actions = number_actions)

# BUILDING THE DQN MODEL BY SIMPLY CREATING AN OBJECT OF THE DQN CLASS
dqn = dqn.DQN(max_memory = max_memory, discount = 0.95)
